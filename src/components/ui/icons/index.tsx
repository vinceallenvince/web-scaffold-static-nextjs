 ...
 * 
 * This file contains reusable icon components to be used throughout the application.
 * All icons follow a consistent API and are accessible.
 */
...
export const EmailIcon: React.FC<IconProps> = ({ size = 16, className }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
