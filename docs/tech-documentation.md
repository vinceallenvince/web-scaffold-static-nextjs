...
|------------|-------------------|-------------|
| Next.js | [https://nextjs.org/docs](https://nextjs.org/docs) | Official Next.js documentation covering App Router, Server Components, static generation |
...
| Lucide Icons | [https://lucide.dev/guide/](https://lucide.dev/guide/) | Icon library used throughout the app |
...
| Prettier | [https://prettier.io/docs/en/](https://prettier.io/docs/en/) | Code formatting |
